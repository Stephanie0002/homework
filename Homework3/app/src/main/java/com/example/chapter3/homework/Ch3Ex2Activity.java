...
public class Ch3Ex2Activity extends AppCompatActivity {
    ...
    private void resetTargetAnimation() {
        ...
        ObjectAnimator animator_scaleX = ObjectAnimator.ofFloat(findViewById(R.id.target),
                "scaleX",1,2);
        ...
        ObjectAnimator animator_scaleY = ObjectAnimator.ofFloat(findViewById(R.id.target),
                "scaleY",1,2);
        ...
        ObjectAnimator animator_alpha = ObjectAnimator.ofFloat(findViewById(R.id.target),
                "alpha",1f,1.5f);
