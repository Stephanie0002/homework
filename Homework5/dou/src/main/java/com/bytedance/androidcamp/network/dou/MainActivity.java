...
public class MainActivity extends AppCompatActivity {
    ...
    private void postVideo() {
        ...
        miniDouyinService.postVideo("13387343676", "黄梓淇", coverImagePart, videoPart).enqueue(
        ...
        miniDouyinService.getVideos().enqueue(new Callback<GetVideosResponse>() {
            ...
            public void onResponse(Call<GetVideosResponse> call, Response<GetVideosResponse> response) {
                if (response.body() != null && response.body().videos != null) {
                    ...
                    {
                        if((mVideos.get(i).studentId).equals("13387343676"))
                        {
                            tempVedio.add(mVideos.get(i));
                        }
                    }
                    mVideos = tempVedio;
                    Toast.makeText(MainActivity.this, "上传人id：" + mVideos.get(0).studentId, Toast.LENGTH_SHORT)
                            .show();
